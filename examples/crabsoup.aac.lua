-- Crabsoup test script: AAC (ADTS) broadcast.
--
-- Run: ./target/release/crabsoup -c examples/crabsoup.aac.lua
-- Verify: ffprobe http://localhost:8000/crabsoup.aac
...
output.icecast({host = "localhost", port = 8000,
                mount = "/crabsoup.aac", format = "aac", bitrate = 128000,
                source_user = "source", source_password = "hackme",
                name = "Crabsoup", description = "Crabsoup AAC test stream",
